...
import worker from "/home/theryston/Projects/jsx-mail/apps/api/.wrangler/tmp/bundle-inIf3C/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/theryston/Projects/jsx-mail/node_modules/.pnpm/wrangler@3.28.3_@cloudflare+workers-types@4.20240208.0/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/theryston/Projects/jsx-mail/apps/api/.wrangler/tmp/bundle-inIf3C/middleware-insertion-facade.js";
